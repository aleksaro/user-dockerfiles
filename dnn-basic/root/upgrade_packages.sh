...
function upgrade_packages () {
    if [ -z "$1" ]; then
        ...
        echo 'Installing PyTorch v. 0.1.9.post2 ...'
        pip3 install --upgrade https://s3.amazonaws.com/pytorch/whl/cu80/torch-0.1.9.post2-cp35-cp35m-linux_x86_64.whl
        ...
        echo "* 'pytorch' - Install PyTorch 0.1.9.post2"

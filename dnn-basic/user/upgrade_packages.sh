...
function upgrade_packages () {
    if [ -z "$1" ]; then
        ...
        echo 'Installing PyTorch v. 0.2.0.post3 ...'
        pip3 install --upgrade http://download.pytorch.org/whl/cu80/torch-0.2.0.post3-cp35-cp35m-manylinux1_x86_64.whl
        ...
        echo "* 'pytorch' - Install PyTorch 0.2.0.post3"
